...
var licenses = {
        b1: "[![License](https: //img.shields.io/badge/License-Boost%201.0-lightblue.svg)](https://www.boost.org/LICENSE_1_0.txt)",
        b2: "[![License](https: //img.shields.io/badge/License-BSD%203--Clause-blue.svg)](https://opensource.org/licenses/BSD-3-Clause)",
        b3: "[![License](https: //img.shields.io/badge/License-BSD%202--Clause-orange.svg)](https://opensource.org/licenses/BSD-2-Clause)",
    }
    // Prompt the user
inquirer.prompt([{
        type: 'input',
        ...
        name: 'License',
        choices: [licenses.b1, licenses.b2, licenses.b3]
    }])
